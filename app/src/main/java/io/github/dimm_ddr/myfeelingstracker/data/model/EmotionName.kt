package io.github.dimm_ddr.myfeelingstracker.data.model

import android.content.Context
import androidx.annotation.StringRes
import io.github.dimm_ddr.myfeelingstracker.R
 ...
 */
object EmotionName {
    private val emotionStringResIds =
        mapOf(
            EmotionCategory.JOY to
                mapOf(
            ...
            EmotionCategory.ANTICIPATION to
                mapOf(
    ...
    fun getName(context: Context, category: EmotionCategory, intensity: IntensityLevel): String =
        context.getString(getStringResId(category, intensity))
     ...
     */
    fun getNamesForCategory(
        context: Context,
        category: EmotionCategory
    ): Map<IntensityLevel, String> = getStringResIdsForCategory(category).mapValues { (_, resId) ->
